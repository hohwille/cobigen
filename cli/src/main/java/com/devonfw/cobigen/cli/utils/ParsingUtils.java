...
public class ParsingUtils {
     ...
     */
    private static Logger LOG = LoggerFactory.getLogger(ParsingUtils.class);
    ...
    public static JavaContext getJavaContext(File inputFile, File inputProject) {
        ...
        try {
            ...
            throw new IllegalStateException("Compiled class " + e.getMessage()
                + " has not been found. Most probably you need to build project " + inputProject.toString() + " .");
        } catch (Exception e) {
            throw new IllegalStateException("Transitive dependencies have not been found on your m2 repository (Maven). "
